...
function Campaigncalender() {
    ...
    return (
        <div>
            ...
            {showModal && (
                <div className="custom-modal-for-dasboard">
                    <div className="custom-modal-content-for-dasboard">
                        <h2>Campaign on this Month</h2>
                        <ul>
                            {selectedDateEvents.map((event, index) => (
                                <li key={index} onClick={() => handleEventClick(event)}>
                                    {event.title}
                                    <span className='ms-5' >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-box-arrow-up-right " viewBox="0 0 16 16">
