...
//                         <button onClick={addMoreProducts} className="btn btn-primary mt-3">Add More Products</button>

//                         <button onClick={handleSave} className="btn btn-success mt-3">Save Invoice</button>
//                     </div>
//                 </div>
//             )}
//         </>
