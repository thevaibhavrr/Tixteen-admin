...
const ManageClients = () => {
    ...
    const [showDetailsPopup, setShowDetailsPopup] = useState(false); // New state for view more popup
    ...
    return (
        <>
            ...
            <div className="manage-industry-chart" style={{ marginBottom: "100px" }} >
                        ...
                        {clients.map((client, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    ...
                                    <span onClick={() => handleDelete(client)}>
                                    ...
                                    <span onClick={() => handleViewMore(client)} className='btn btn-warning' >
                                        View More
                                    </span>
                                </td>
                            </tr>
                ...
                <Link to="/management/add-client" className="create-campaign-button">
                        Add New Client 
                    </Link>
