    ...
    <>
      ...
      <div className="campaign-details-unique">
        ...
        <div className="campaign-content-unique">
          ...
          <p className="w-75"> <a href={`https://tixteen.com/verified/creator/campaign/details/${campaignDetails?._id}`} target="_blank" rel="noopener noreferrer" className='view-applied-users-button w-25' >Apply Link <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
